...
export default function TicketSelector({
  ...
  return (
    <View style={styles.containerRelative}>
      <View style={[styles.ticketCard, disabled && styles.ticketCardDisabled]}>
        <View style={styles.ticketSelectorRow}>
          <Text style={[styles.ticketSelectorLabel, disabled && styles.ticketSelectorLabelDisabled]}>{label}</Text>
          {rightText ? <Text style={[styles.priceText, disabled && styles.priceTextDisabled]}>{rightText}</Text> : null}
        </View>
...
const styles = StyleSheet.create({
  ...
  ticketSelectorLabelDisabled: {
    color: COLORS.textSecondary,
    fontWeight: "600",
  },
  priceText: { color: COLORS.textPrimary, fontWeight: "700" },
  priceTextDisabled: { color: COLORS.textSecondary, fontWeight: "600" },
